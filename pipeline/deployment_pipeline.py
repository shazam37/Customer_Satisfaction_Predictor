...
def deployment_trigger(
    ...
    """
    Implements a simple model deployment trigger that looks at the input model accuracy and decides whether it is good enough to be deployed
    """
...
class MLFlowDeploymentLoaderStepParameters(BaseParameters):
    ...
    Attributes:
        ...
        step_name: the name of the step that deployed the MLFlow predition server 
